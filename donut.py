import pygame
import math
import colorsys # for the donut color 

# Note : close your eyes half for better view of donut
# Note : all these were not fully written by me, took help of internet for formula's and logic's
...
theta_spacing = 10 # controls density of a primary circle
phi_spacing = 2 # for faster rotation change to 2, 3 or more, but first change 86, 87 lines as commented

chars = ".,a8H!$h3k.@"  # luminance index give any characters to display
